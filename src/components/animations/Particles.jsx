...
const Particles = ({
  ...
  particleSpread   = 8,
  speed            = 0.04,
  particleColors   = ['#00f2fe', '#7c3aed', '#8b5cf6', '#00c4cf'],
  ...
  }, [particleCount, particleSpread, speed, particleColors, alphaParticles, particleBaseSize, sizeRandomness, cameraDistance])
